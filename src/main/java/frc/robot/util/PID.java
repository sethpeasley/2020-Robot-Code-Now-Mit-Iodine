...
public class PID {
     ...
     * calculation. This defaults to 1 in the constructor, which has worked well for
     * 1114 the past few years.
     */
    ...
    {
        if (m_previousValue <= m_desiredValue + m_errorEpsilon && m_previousValue >= m_desiredValue - m_errorEpsilon
                && !m_firstCycle)
        {
